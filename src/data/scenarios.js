...
export const SCENARIOS = [
  ...
  },
  {
    ...
    name: 'Carsi Bolgesi',
    difficulty: 'Basit',
    description: 'Daginik cokmeler - 3 enkaz, 6 depremzede.',
    enkaz: 3,
    perEnkaz: 2,
  },
  {
  ...
  {
    id: 'merkez',
    name: 'Sehir Merkezi Cokusu',
    difficulty: 'Zor',
    description: 'Agir yapisal cokus - 4 enkaz, 12 depremzede.',
    enkaz: 4,
    perEnkaz: 3,
  },
  {
    id: 'hastane',
    name: 'Hastane Bolgesi Krizi',
    difficulty: 'Zor',
    description: 'Yollar enkazla kapali - 5 enkaz, 15 depremzede.',
    enkaz: 5,
    perEnkaz: 3,
  },
  {
